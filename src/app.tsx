...
import SidebarLayout from "@/routes/sidebar_layout";
  ...
  return (
    <SidebarLayout>
      <div className="h-[100vh] w-full bg-gradient-to-br from-[#F48120]/10 via-background/30 to-[#FAAD3F]/10 backdrop-blur-md p-4 flex justify-center items-center bg-fixed overflow-hidden">
        <div className="bg-background h-[calc(100vh-2rem)] w-full mx-auto flex flex-col shadow-xl rounded-md overflow-hidden relative border border-assistant-border/20">
